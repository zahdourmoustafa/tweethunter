...
export const AI_TOOLS = {
  ...
  left: [
    ...
    },
    {
      ...
      name: "Keep Writing",
      icon: "✍️",
      description: "Continue/expand current content",
    },
    {
      id: "add-emojis",
      name: "Add Emojis",
    ...
    },
    {
      ...
      name: "Make Shorter",
      icon: "✂️",
      description: "Condense while maintaining impact",
    },
    {
      id: "expand-tweet",
      name: "Expand Tweet",
      icon: "🔄",
      description: "Convert to thread format",
    },
    {
      id: "create-hook",
      name: "Create Hook",
      icon: "▶️",
      description: "Generate attention-grabbing openers",
    },
    {
      id: "create-cta",
      name: "Create CTA",
      icon: "📢",
      description: "Add compelling call-to-actions",
    },
  ],
  ...
  right: [
    ...
    },
    {
      ...
      name: "More Assertive",
      icon: "💪",
      description: "Confident, stronger tone",
    },
    {
      id: "more-casual",
      name: "More Casual",
      icon: "😎",
      description: "Conversational, relatable tone",
    },
    {
      id: "more-formal",
      name: "More Formal",
